...
> **Privacy note:** Many students don’t consent to being recorded during live lessons, especially because classroom conversations can be personal. AfterClass shifts speech analytics to dedicated homework exercises where the student is focused on a specific activity (not personal discussion), making it easier to capture consent and measure speaking signals in a safer, more controlled context.
