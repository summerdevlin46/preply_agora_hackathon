...
Improve it by:
- Specifying the grammar focus, tense, or structure
- Listing key vocabulary explicitly
- Noting the student's proficiency level, using CEFR if inferable
- Mentioning any topics, themes, or activities covered
- Adding useful detail that would help an AI tailor an avatar session

Keep it concise, around 3 to 5 sentences. Return ONLY the improved context text. Do not include a preamble, labels, markdown, or explanation.`;
